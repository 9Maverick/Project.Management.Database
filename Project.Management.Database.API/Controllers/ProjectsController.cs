...
namespace Project.Management.Database.API.Controllers;
...
public class ProjectsController : ControllerBase
{
	...
	public async Task<IActionResult> PutProject(ProjectDTO projectDTO)
	{
		...
		var project = _mapper.Map<Domain.Project>(projectDTO);
	...
	// POST: api/Projects
	[HttpPost]
	public async Task<ActionResult<Domain.Project>> PostProject(ProjectDTO projectDTO)
	{
		if (!IsDTOValid(projectDTO))
		{
			return BadRequest();
